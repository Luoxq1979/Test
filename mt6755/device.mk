...
PRODUCT_PACKAGES += libmnlp_mt6755
...
ifeq ($(strip $(MTK_WLAN_SUPPORT)), yes)
  ifeq ($(strip $(MTK_PLATFORM)), MT8127)
    ...
    ifeq ($(strip $(MTK_PLATFORM)), MT6571)
      ...
      ifeq ($(strip $(MTK_PLATFORM)), MT6755)
        PRODUCT_PACKAGES += WIFI_RAM_CODE_6755
      else
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
  ifeq ($(MTK_PLATFORM),$(filter $(MTK_PLATFORM),MT6755))
...
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.mt6755.rc:root/init.mt6755.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/factory_init.rc:root/factory_init.rc
...
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.c2k.rc:root/init.c2k.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/meta_init.c2k.rc:root/meta_init.c2k.rc
endif

ifeq ($(strip $(MTK_FAT_ON_NAND)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.fon.rc:root/init.fon.rc
endif

PRODUCT_COPY_FILES += device/mediatek/mt6755/init.xlog.rc:root/init.xlog.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/meta_init.modem.rc:root/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/meta_init.rc:root/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.mt6755.usb.rc:root/init.mt6755.usb.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.recovery.mt6755.rc:root/init.recovery.mt6755.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/egl.cfg:system/lib/egl/egl.cfg
ifeq ($(strip $(MTK_EMMC_SUPPORT)), yes)
else
...
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs.xml:system/etc/media_codecs.xml
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_performance.xml:system/etc/media_codecs_performance.xml
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_audio.xml:system/etc/media_codecs_mediatek_audio.xml
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs.xml:system/etc/permissions/media_codecs.xml
PRODUCT_COPY_FILES += device/mediatek/mt6755/mtk_omx_core.cfg:system/etc/mtk_omx_core.cfg
...
#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt6755/audio_device.xml:system/etc/audio_device.xml

ifeq ($(strip $(TRUSTONIC_TEE_SUPPORT)), yes)
  PRODUCT_PACKAGES += keystore.mt6755
  PRODUCT_PACKAGES += libMcGatekeeper
  PRODUCT_COPY_FILES += device/mediatek/mt6755/init.trustonic.rc:root/init.trustonic.rc
  PRODUCT_PACKAGES += liburee_meta_drmkeyinstall
  PRODUCT_PACKAGES += rda
endif

ifeq ($(strip $(MICROTRUST_TEE_SUPPORT)), yes)
  PRODUCT_COPY_FILES += device/mediatek/mt6755/init.microtrust.rc:root/init.microtrust.rc
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/trustzone/microtrust/source/platform/mt6755/teei/alipayapp:system/thh/alipayapp
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/trustzone/microtrust/source/platform/mt6755/teei/soter.raw:system/thh/soter.raw
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/trustzone/microtrust/source/platform/mt6755/teei/fp_server:system/thh/fp_server 
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/trustzone/microtrust/source/platform/mt6755/teei/init_thh:system/bin/init_thh
